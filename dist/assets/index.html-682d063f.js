...
第一个脚本特征：1,2,1,1,1
第二个脚本特征：0,0,1,1,0
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5);function k(h,m){const s=c("DocsAD");return i(),l("div",null,[d,r,u,a(s),a(s),a(s),v])}const g=t(o,[["render",k],["__file","index.html.vue"]]);export{g as default};

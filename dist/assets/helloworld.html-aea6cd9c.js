import{_ as a,K as e,L as t,a5 as p,M as n,N as o,W as c,F as i}from"./framework-edebdfe1.js";const l={},u=n("h1",{id:"helloworld",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#helloworld","aria-hidden":"true"},"#"),o(" HelloWorld")],-1),r=c(`<h2 id="native" tabindex="-1"><a class="header-anchor" href="#native" aria-hidden="true">#</a> Native</h2><h3 id="rust" tabindex="-1"><a class="header-anchor" href="#rust" aria-hidden="true">#</a> Rust</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">cargo</span> init helloworld <span class="token parameter variable">--lib</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,16);function d(k,v){const s=i("DocsAD");return e(),t("div",null,[u,p(s),r])}const b=a(l,[["render",d],["__file","helloworld.html.vue"]]);export{b as default};

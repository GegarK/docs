        ...
        notice: [
          {
            ...
            title: "重要公告（核心基础）",
            content:
              '<ul><li>思维教程：<a class="deelmind" target="_blank" href="https://all.deelmind.com.cn/">《随缘自然而然》</a></li><li>群内课程：<a href="/pay/class/tiny">《群内直播课程》</a></li><li>群内课程：<a href="/pay/class/bin">《二进制安全》</a></li><li>群内课程：<a href="/pay/class/ai">《网络安全AI课程》</a></li><li>信任标准：不信我不要找我，先了解我，或者学一下思维课程<a class="deelmind" target="_blank" href="https://all.deelmind.com.cn/">《随缘自然而然》</a></li><li><a href="/pay/class/pentest">付费辅导：《一对一辅导》</a></li><li>联系方式：<a href="/pay/me">点击添加</a></li></ul>'
          },

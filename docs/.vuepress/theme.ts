        ...
        notice: [
          {
            ...
            title: "重要公告（核心基础）",
            content:
              '<ul><li>思维教程：<a class="deelmind" target="_blank" href="https://all.deelmind.com.cn/">《随缘自然而然》</a></li><li>加群课程：<a href="/pay/class/tiny">《加群直播课程》</a></li><li>付费课程：<a href="/pay/class/pentest">《网络安全一对一辅导》</a></li><li>付费课程：<a href="/pay/class/bin">《二进制安全》</a></li><li>付费课程：<a href="/pay/class/ai">《网络安全AI课程》</a></li><li>信任标准：不信我不要找我，先了解我，或者学一下思维课程<a class="deelmind" target="_blank" href="https://all.deelmind.com.cn/">《随缘自然而然》</a></li></ul>'
          },
